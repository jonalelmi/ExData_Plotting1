...
plot(dt, df$Global_active_power, type='s', ylab='Global Active Power', xlab='')

plot(dt, df$Voltage, type='s', xlab='datetime', ylab='Voltage')
...
plot(dt, df$Global_reactive_power, type='s', xlab='datetime')
dev.off()